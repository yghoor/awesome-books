...
var luxon = (function (e) {
  ...
  function i(e, t) {
    (e.prototype = Object.create(t.prototype)), u((e.prototype.constructor = e), t);
  }
  function a(e) {
    ...
    if (
      ...
      (n = (function (e, t) {
        if (e) {
          ...
          return 'Map' ===
            (n = 'Object' === n && e.constructor ? e.constructor.name : n) || 'Set' === n
            ? Array.from(e)
  ...
  var n = (function (e) {
    ...
    R = { year: g, month: S, day: g, hour: g, minute: g, second: g, timeZoneName: w },
    H = { year: g, month: S, day: g, weekday: S, hour: g, minute: g, timeZoneName: S },
    P = {
      year: g,
      month: S,
      day: g,
      ...
      return (
        ...
        (e.formatDateTimeFromString = function (r, e) {
          var n = this,
            ...
            f = function (e) {
              return i ? ((t = r), Ee(e)[t.year < 0 ? 0 : 1]) : o({ era: e }, 'era');
              var t;
            };
          ...
          var n =
            ...
            r = n.formatToParts
              ...
              : ((a = t),
                ...
                (a = (s = /(\d+)\/(\d+)\/(\d+) (AD|BC),? (\d+):(\d+):(\d+)/.exec(u))[1]),
                (u = s[2]),
              ...
              0 !== e.offset && qe.create(i).valid
                ...
                : ((r = 'UTC'),
                  n.timeZoneName
                    ? (this.dt = e)
                    : (this.dt =
                        0 === e.offset ? e : tr.fromMillis(e.ts + 60 * e.offset * 1e3))))
            : 'system' === e.zone.type
            ? (this.dt = e)
        ...
        (this.opts = s({ style: 'long' }, n)),
          !t &&
            ...
            (this.rtf = (function (e, t) {
              ...
              return (
                (n = rt[r]) || ((n = new Intl.RelativeTimeFormat(e, t)), (rt[r] = n)), n
              );
            })(e, n));
      }
      var t = e.prototype;
        ...
        (i.create = function (e, t, n, r) {
          ...
          return new i(
            e ||
              (r
                ? 'en-US'
                : (it = it || new Intl.DateTimeFormat().resolvedOptions().locale)),
      ...
      return (
        ...
        (e.eras = function (e, t) {
          ...
          return ot(this, e, (t = void 0 === t ? !0 : t), Ee, function () {
            ...
            return (
              n.eraCache[e] ||
                (n.eraCache[e] = [tr.utc(-40, 1, 1), tr.utc(2017, 1, 1)].map(function (
                  e
                ) {
  ...
  var mt = /(?:(Z)|([+-]\d\d)(?::?(\d\d))?)/,
    ...
    n = RegExp(yt.source + ('(?:' + mt.source + '?(?:\\[(' + ye.source + ')\\])?)?')),
    w = RegExp('(?:T' + n.source + ')?'),
  ...
  var Bt = (function () {
      ...
      return (
        ...
        (e.plus = function (e) {
          ...
          for (var t = m.fromDurationLike(e), n = {}, r = k(Jt); !(i = r()).done; ) {
            var i = i.value;
          ...
          for (
            ...
            var a = a.value,
              t =
                1 === (n += 's' === a.type ? 1 : -1)
                  ? a.time
                  : (t && +t != +a.time && r.push(c.fromDateTimes(t, a.time)), null);
          return c.merge(r);
        }),
    ...
    var a,
      ...
      s = n
        ? ((c = null),
          ...
          W(a.q) || (a.M = 3 * (a.q - 1) + 1),
          W(a.h) ||
            (a.h < 12 && 1 === a.a ? (a.h += 12) : 12 === a.h && 0 === a.a && (a.h = 0)),
          0 === a.G && a.y && (a.y = -a.y),
          W(a.u) || (a.S = te(a.u)),
          [
  ...
  function Dn(e) {
    ...
    return (
      o < 1 ? (o = ue((t = n - 1))) : o > ue(n) ? ((t = n + 1), (o = 1)) : (t = n),
  ...
  function En(e) {
    var t,
      ...
      a = ie(n),
      o = 7 * r + i - o - 3;
    o < 1 ? (o += ie((t = n - 1))) : a < o ? ((t = n + 1), (o -= ie(n))) : (t = n);
    o = Nn(t, o);
  ...
  function Pn(e, t, n, r, i, o) {
    ...
    return (
      t
        ? ((a += ':'), (a += K(e.c.minute)), (0 === e.c.second && n) || (a += ':'))
        : (a += K(e.c.minute)),
      (0 === e.c.second && n) ||
        ((a += K(e.c.second)),
        (0 === e.c.millisecond && r) || ((a += '.'), (a += K(e.c.millisecond, 3)))),
      i &&
    ...
    (w.now = function () {
      ...
      (w.fromMillis = function (e, t) {
        if ((void 0 === t && (t = {}), J(e)))
          return e < -864e13 || 864e13 < e
            ...
            : new w({ ts: e, zone: He(t.zone, Be.defaultZone), loc: ct.fromObject(t) });
        throw new p(
      ...
      (w.fromFormat = function (e, t, n) {
        ...
        var r = n,
          ...
          i = [(r = kn(a, e, (r = t))).result, r.zone, r.specificOffset, r.invalidReason],
          o = i[0],
          a = i[1],
          r = i[2],
          i = i[3];
    ...
    return (
      ...
      (e.setZone = function (e, t) {
        ...
        if (e.isValid) {
          r = this.ts;
          return (
            (t || n) && ((n = e.offset(this.ts)), (r = qn(this.toObject(), n, e)[0])),
            An(this, { ts: r, zone: e })
          );
        }
      ...
      (e.minus = function (e) {
        return this.isValid ? An(this, _n(this, Bt.fromDurationLike(e).negate())) : this;
      }),
      ...
      (e.toLocaleString = function (e, t) {
        return (
          void 0 === e && (e = b),
          void 0 === t && (t = {}),
          this.isValid ? xe.create(this.loc.clone(t), e).formatDateTime(this) : Fn
        );
      }),
      ...
      (e.toRelative = function (e) {
        ...
        return (
          ...
          Xn(t, this.plus(n), s({}, e, { numeric: 'always', units: r, unit: i }))
        );
      }),
